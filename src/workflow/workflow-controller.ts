...
import { toolPolicy, type ToolPolicy } from "./tool-policy.js";
import { capabilityState } from "../education/capability-runtime.js";
import { addStudentPlanStep, approveStudentPlan } from "../education/student-plan.js";
import type { LearningSession, LearningStage, LearningStateUpdate } from "./types.js";
import type { IntentRoute, LearningIntent } from "../education/intent.js";
...
export class WorkflowController {
	...
	getAllowedTools(): readonly string[] {
		return this.policy.allowedTools(this.state.stage);
	}

	getRegisteredTools(): readonly string[] {
		return this.policy.registeredTools();
	}
