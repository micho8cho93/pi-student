...
import { createSandboxGrepTool, createSandboxRuntime, createSandboxToolDefinitions, readSandboxMode } from "../sandbox/sandbox-manager.js";
...
import { inspectProjectContext, projectContextFacts, type ProjectContext } from "../education/project-context.js";
import { routeIntent, type IntentRoute } from "../education/intent.js";
...
import { createStudentPlanExtension } from "../extensions/student-plan.js";
import { createSaveToDesktopExtension } from "../extensions/save-to-desktop.js";
...
import { classifyTerminalCommand, isSafeInspectionCommand, isSafeVerificationCommand, isWorkspacePath } from "../terminal/command-policy.js";
import { formatProviderErrorMessage } from "../terminal/ui.js";
import { createBundledThemes, DEFAULT_THEME } from "../terminal/themes.js";
import { createTeacherTelemetryExtension } from "../telemetry/pi-integration.js";
import { appendTranscript, DictationCancelledError, DictationController } from "../voice/dictation.js";
import { runDictationSetup } from "../voice/dictation-setup.js";
import {
	cueText,
...
import { createLearningSession, type LearningSession } from "../workflow/types.js";
import { capabilityState, guardCapabilitySession } from "../education/capability-runtime.js";
import { createProjectCapabilitiesExtension } from "../extensions/project-capabilities.js";
import { modelAllowed, allowedReasoningLevels } from "../education/capability-policy.js";
...
export async function createLearningAgentRuntime(
	...
	const sandboxRuntime = sandbox ?? createSandboxRuntime(readSandboxMode());
		...
		const services = await createAgentSessionServices({
			...
			resourceLoaderOptions: {
				...
				extensionFactories: [
					...
					createTeacherTelemetryExtension(workflow, sandboxRuntime),
				],
...
export async function createLearningAgentSession(
	...
	const unsubscribeFromStages = workflow.onStageChange(() => {
