...
select throws_ok($$ select public.assign_sandbox_profile('82000000-0000-0000-0000-000000000001','organization',null,null,current_setting('env.profile')::uuid,1) $$,'22023','Only ready profiles can be assigned','pending build is not executable');
