...
import { patchGitStateSource, patchCommitsUiSource, patchCommitHistorySource } from "@pi-student/paseo-adapter/git-state-patch";

const require = createRequire(import.meta.url);
const serverRoot = path.resolve(path.dirname(require.resolve("@getpaseo/cli/package.json")), "..", "server", "dist", "server");
