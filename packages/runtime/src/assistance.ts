...
const HEADLINES: Partial<Record<CapabilityRestriction, string>> = {
	...
	model_unavailable: "The selected AI model is unavailable. Choose another approved model or retry later.",
	authentication_failure: "Reconnect your AI provider to continue.",
	transient_failure: "The AI connection failed temporarily. Try again.",
