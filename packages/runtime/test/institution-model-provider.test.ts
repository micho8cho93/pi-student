...
it("registers approved institution profiles against the gateway with a student token", async () => {
	...
	provider.configureHostedProfiles("74000000-0000-0000-0000-000000000001", "https://models.example.test", [{
		id: "75000000-0000-0000-0000-000000000001", organizationId: "72000000-0000-0000-0000-000000000001", fallbackProfileId: "75000000-0000-0000-0000-000000000002",
	...
	expect(provider.fallbackFor("institution", "75000000-0000-0000-0000-000000000001")).toBe("institution/75000000-0000-0000-0000-000000000002");
